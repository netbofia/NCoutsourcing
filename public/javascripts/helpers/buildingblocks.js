...
function makeToast(title,body){
    ...
    let strong=mkel('strong',{class:"me-auto pr-4"})
    let small=mkel('small',{class:"text-muted"})
    strong.textContent=title
    small.textContent='just now'
    let buttonClose=mkel('button',{class:"btn-close",type:"button","data-dismiss":"toast","aria-label":"Close"})
